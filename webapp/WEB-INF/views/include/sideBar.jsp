...
<div class="d-flex flex-column flex-shrink-0 p-3 sidebar" style="width: 230px;">
	<div>
		<a href="/"
			class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
			<span class="fs-4 logo">SCGW</span>
		</a>
		<hr>
			...
			<li>
				...
				<div class="collapse" id="personnel-collapse">
					<ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ">
						...
						<li><a href="#" class="d-inline-flex text-decoration-none rounded">부서관리</a></li>
						<li><a href="#" class="d-inline-flex text-decoration-none rounded">자유</a></li>
					</ul>
				</div>
			</li>
